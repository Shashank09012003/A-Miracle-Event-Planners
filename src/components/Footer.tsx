...
import { Facebook, Instagram, MessageCircle, Phone, MapPin, Mail, Sparkles } from "lucide-react";
...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 text-white overflow-hidden" itemScope itemType="https://schema.org/Organization">
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-12 gap-12 md:gap-16">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 group">
                ...
                <div>
                  <span className="font-bold text-2xl bg-gradient-to-r from-purple-400 via-pink-400 to-orange-400 bg-clip-text text-transparent" itemProp="name">
                    A Miracle Event Planners
                  </span>
                  <div className="flex items-center gap-1 text-xs text-purple-300">
                    <Sparkles className="w-3 h-3" />
                    <span>Born to break the pattern , Built to create the moment</span>
                  </div>
                </div>
              </div>
              
              <p className="text-gray-300 max-w-md leading-relaxed text-sm" itemProp="description">
                Transform your events into magical experiences. Professional event planning services in Jabalpur, specializing in weddings, birthday parties, corporate events, and festivals.
              </p>
            </div>
          ...
          <div className="lg:col-span-4 space-y-4" itemProp="address" itemScope itemType="https://schema.org/PostalAddress">
            ...
            <div className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 hover:bg-white/10 hover:border-purple-500/50 transition-all duration-300">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <a href="tel:+919303500200" className="block text-white hover:text-purple-400 transition-colors font-medium" itemProp="telephone">
                    +91 9303500200
                  </a>
                  <a href="tel:+919977705032" className="block text-white hover:text-purple-400 transition-colors font-medium" itemProp="telephone">
                    +91 9977705032
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <address className="not-italic text-white text-sm leading-relaxed">
                    <span itemProp="streetAddress">211 rajul landmark near opposite jabalpur hospital </span>,<br />
                    <span itemProp="addressLocality">Russel Chowk, Jabalpur</span>, <span itemProp="addressRegion">MP</span> <span itemProp="postalCode">482001</span>
                  </address>
                </div>
              </div>
            </div>
            ...
            <div className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 hover:bg-white/10 hover:border-purple-500/50 transition-all duration-300">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <a href="mailto:info@amiracleeventplanners.com" className="text-white hover:text-purple-400 transition-colors break-all font-medium" itemProp="email">

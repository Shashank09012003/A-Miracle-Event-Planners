  ...
  const services = [
    {
      ...
      price: "Starting from 12 lakhs upto 80 lakhs",
    },
    {
      title: "Birthdays & Anniversary",
      gradient: "gradient-birthday",
      icon: "🎂💝",
      description: "Memorable birthday and anniversary celebrations for all ages",
      features: [
        "Custom theme design",
        "Venue decoration",
    ...
    },
    {
      ...
      price: "Custom pricing (according to the requirement !)",
    },
    {
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Our Event Planning <span className="text-gradient">Services</span>
              </h1>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Our event planning experts are here to help you choose the perfect package for your celebration
              </p>
